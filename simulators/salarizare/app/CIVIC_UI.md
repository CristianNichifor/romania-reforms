...
The browser runner also checks the reviewed v0.2.0 artifact URL, version and integrity in the manifest/lockfile. Intentional dependency upgrades must update that guard after reviewing the new release. Browser snapshots reject shared inputs/selects missing scoped Field composition or a label.
