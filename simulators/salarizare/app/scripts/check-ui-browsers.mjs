...
const artifact = 'https://github.com/CristianNichifor/civic-ui/releases/download/v0.5.0/civic-ui-0.5.0.tgz';
...
assert.equal(dependency.version, '0.5.0');
...
// 364ba9e8f1dadf8a66f50c9d6f30f8a0702ef5aa1a68929882f002a428f23a1e  civic-ui-0.5.0.tgz
// A hash taken from the lockfile only proves npm downloaded the same thing twice.
assert.equal(dependency.integrity, 'sha512-Foi8E1TxPMnSJNuVuK96dYZRrALwCzKFP/tbOQJJ269Sa4fRxNa+8rgJwajpP6rzsuLvsZoAS2LaqFVRXGuSDw==');
