        ...
        "limitations": [
            {
                ...
                "text": (
                    ...
                    "sporurile pentru care s-au reținut contribuții, pe cinci ani. Cât "
                    "cântăresc sporurile nu se publică, așa că scăderea calculată aici — "
                    "doar pe indemnizație — este maximul posibil, nu o estimare. Cu sporuri "
                    "mari în bază, trecerea de la 80% la 55% taie mult mai puțin decât pare."
                ),
                "severity": "blocking",
                "affects": ["pensii"],
            },
