    ...
    document = {
        ...
        "limitations": [
            ...
            },
            {
                ...
                "text": (
                    "Ce județe ține fiecare curte de apel nu se află în niciuna dintre sursele "
                    "acestei construcții: HG 1217/2023 arondează doar judecătoriile, iar anexele "
                    "CSM listează instanțele plat, alfabetic, fără să le grupeze pe curți. "
                    "Volumul unei curți e trecut la regiunea în care se află sediul ei, deci "
                    "acolo unde o circumscripție trece peste granița regiunii, dosarele sunt "
                    "numărate în coloana greșită. Numărul de instanțe și distanțele nu sunt "
                    "afectate. Ce ar închide golul e o sursă anume — Anexa nr. 1 lit. C la Legea "
                    "304/2022 — pe care construcția nu a putut s-o ia: portalul legislativ "
                    "servește corpul legii fără anexe, iar PDF-ul de pe portal.just.ro are "
                    "lanțul de certificate rupt. Lipsește un document identificabil, nu o "
                    "informație care nu există."
                ),
                "severity": "blocking",
                "affects": ["curti-de-apel"],
            },
