...
def test_committed_road_access_view_routes_only_accepted_provider_points():
    ...
    assert document["summary"]["providerSnaps"] == len(document["providerSnaps"]) == 252
    assert document["summary"]["pointAccessBlockedProviders"] == 340
    assert document["summary"]["pointAccessNamedExclusions"] == 340
